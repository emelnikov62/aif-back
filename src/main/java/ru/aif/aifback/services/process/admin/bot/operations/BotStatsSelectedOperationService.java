...
public class BotStatsSelectedOperationService implements AdminBotOperationService {
     ...
     * @return count
     */
    private int calcCountByType(List<ClientRecord> records, ClientRecordType type) {
