...
import static ru.aif.aifback.services.process.client.bot.record.enums.ClientBotRecordOperationType.BOT_HISTORY;
...
/**
 * History operation API service.
 * @author emelnikov
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class HistoryOperationService implements ClientBotOperationService {
