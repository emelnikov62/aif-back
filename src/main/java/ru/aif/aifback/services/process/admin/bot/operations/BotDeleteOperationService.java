...
import static ru.aif.aifback.services.process.admin.constants.AdminBotButtons.DELETE_BOT_ERROR_ANSWER;
import static ru.aif.aifback.services.process.admin.constants.AdminBotButtons.DELETE_BOT_SUCCESS_ANSWER;
...
/**
 * Admin Bot delete operation API service.
 * @author emelnikov
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class BotDeleteOperationService implements AdminBotOperationService {
    ...
    public List<ChatMessage> process(WebhookRequest webhookRequest) {
        ...
        String answer = DELETE_BOT_ERROR_ANSWER;
