...
public final class TgClientBotRecordButtons {
    ...
    public static InlineKeyboardMarkup createMainMenuKeyboard(String typeBot) {
        if (Objects.equals(typeBot, BotType.BOT_RECORD.getType())) {
            InlineKeyboardMarkup keyboard = new InlineKeyboardMarkup();
            keyboard.addRow(new InlineKeyboardButton(AI_RECORD_TITLE).callbackData(ClientRecordBotOperationType.BOT_AI_RECORD.getType()));
            keyboard.addRow(new InlineKeyboardButton(ACTIVE_TITLE)
                                    .callbackData(String.format("%s;%s", ClientRecordBotOperationType.BOT_RECORDS.getType(), ClientRecordType.ACTIVE.getType())));
            keyboard.addRow(new InlineKeyboardButton(ITEMS_TITLE).callbackData(ClientRecordBotOperationType.BOT_GROUP.getType()));
            keyboard.addRow(new InlineKeyboardButton(HISTORY_TITLE)
                                    .callbackData(String.format("%s;%s", ClientRecordBotOperationType.BOT_RECORDS.getType(), ClientRecordType.NO_ACTIVE.getType())));
            keyboard.addRow(new InlineKeyboardButton(SETTINGS_TITLE).callbackData(ClientRecordBotOperationType.BOT_SETTINGS.getType()));
            return keyboard;
        }
    ...
    public static InlineKeyboardButton[] createBackButton(String callback) {
        return new InlineKeyboardButton[] {
                ...
                new InlineKeyboardButton(MENU_TITLE).callbackData(ClientRecordBotOperationType.BOT_MAIN.getType())
        };
    }
