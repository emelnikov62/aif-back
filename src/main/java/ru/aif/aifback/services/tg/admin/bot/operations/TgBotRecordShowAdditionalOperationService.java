...
/**
 * TG Admin Bot record show additional operation API service.
 * @author emelnikov
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class TgBotRecordShowAdditionalOperationService implements TgAdminBotOperationService {
    ...
    public void process(TgWebhookRequest webhookRequest, TelegramBot bot) {
        ...
        keyboard.addRow(createBackButton(String.format("%s;%s;%s;%s;%s",
