package ru.aif.aifback.services.ai.recognize.tg;
...
/**
 * Telegram voice recognize service.
 * @author emelnikov
 */
@Slf4j
@AllArgsConstructor
@Service
public class TgVoiceRecognizeService implements VoiceRecognizeService {
     ...
     */
    @Override
    public String recognize(WebhookRequest webhookRequest, UserBot userBot) {
        try {
            ...
            HttpEntity<byte[]> entity = new HttpEntity<>(getFileBytes(userBot, webhookRequest), headers);
     ...
     */
    private byte[] getFileBytes(UserBot userBot, WebhookRequest webhookRequest) throws Exception {
